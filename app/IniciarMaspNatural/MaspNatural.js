...
const MaspNatural = () => {
   ...
   const supabase = createClientComponentClient();
    ...
    const ROTEIRO_ID_MASP = 3; // <-- MUDE AQUI para o ID correto
    const GOOGLE_MAPS_LINK = "https://www.google.com/maps/dir/?api=1&origin=My+Location&destination=Parque+Trianon&waypoints=MASP|Restaurante+Taste+And+See"; // <-- Coloque o link correto aqui
  ...
  return (
    ...
    <>
      ...
      <section className={`${styles.printableArea} print-visible`}>
        <img
          src="/Masp-Natural.png" // O caminho para a sua imagem
