...
import RotaCopanRaiz from "../../components/RotaCopanRaiz";
import ParadasCopanRaiz from "../../components/ParadasCopanRaiz";
import styles from "./CopanRaiz.module.css";
import { useRouter } from "next/navigation";

import { useAuth } from "../../context/AuthContext"; // <-- Verifique se o caminho está certo
import { createClientComponentClient } from "@supabase/auth-helpers-nextjs";

const IniciarRoteiroCopanRaiz = () => {
    ...
    const ROTEIRO_ID_COPAN = 12; // <-- MUDE AQUI para o ID correto
    const GOOGLE_MAPS_LINK = "https://www.google.com/maps/dir/?api=1&origin=My+Location&destination=Locadora+Video+Connection&waypoints=Copan|Cafe+Floresta"; // <-- Coloque o link correto aqui
  ...
  return (
    <>
      ...
      <section className={`${styles.printableArea} print-visible`}>
        <img
          src="/Copan-Raiz (1).png" // O caminho para a sua imagem
...
export default IniciarRoteiroCopanRaiz